define(function(require) {
    ...
    module.controller('KbnLineVisController', function($scope, $element, $window, Private) {
        ...
        fty[3] = {
            format: function(d) {
                var formatValue = d3.format(".3s");
                return formatValue(d) + "s";
            }
        };
        fty[4] = {
            format: function(d) {
                var formatValue = d3.format(".3s");
                return formatValue(d) + "o";
            }
        };
        fty[5] = {
            format: function(d) {
            ...
            for (var subchart in metrics) {
                ...
                if (typex == "timeseries") {
                    config.axis.x = {
                        type: 'timeseries',
                        tick: {
                            rotate: $scope.vis.params.configLine_xrotate,
                            format: (typeof $scope.vis.params.configLine.formatx != "undefined") ? $scope.vis.params.configLine.formatx : "%d-%m-%Y"
                        }
                    };
                } else {
                    config.axis.x = {
                ...
                // set params axis Y2
                config.axis.y2 = {
                    show: $scope.vis.params.configLine.enableY2,
                    tick: (typeof $scope.vis.params.configLine.formaty2 != "undefined") ? fty[$scope.vis.params.configLine.formaty2] : "{}"
                };
                ...
                // Set axis labels
                config.axis.x.label = {
                    "text": $scope.vis.params.axisLabel.x,
                    "position": (typeof $scope.vis.params.axisLabel.xPosition != "undefined") ? $scope.vis.params.axisLabel.xPosition : ""
                };
                config.axis.y.label = {
                    "text": $scope.vis.params.axisLabel.y,
                    "position": (typeof $scope.vis.params.axisLabel.yPosition != "undefined") ? $scope.vis.params.axisLabel.yPosition : ""
                };
                config.axis.y2.label = {
                    "text": $scope.vis.params.axisLabel.y2,
                    "position": (typeof $scope.vis.params.axisLabel.y2Position != "undefined") ? $scope.vis.params.axisLabel.y2Position : ""
                };
                ...
                config.grid.y = (typeof $scope.vis.params.configLine.gridyval != "undefined") ? {
                    lines: [{
                        value: $scope.vis.params.configLine.gridyval,
                        text: $scope.vis.params.configLine.gridytxt,
                        position: $scope.vis.params.configLine.gridypos,
                        class: $scope.vis.params.configLine.gridycolor
                    }]
                } : {};
